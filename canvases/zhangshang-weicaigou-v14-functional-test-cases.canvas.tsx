...
batch("专家申请与资料", "EXP", [
  ...
  { scene: "专家资料修改提交", precondition: "专家账号已是专家且资料管理页可用", steps: "资料管理修改资料后提交", expected: "进入待审核，原信息暂不生效", priority: "P0", type: "positive", coverage: "资料修改流程" },
  { scene: "资料管理手写签名提交", precondition: "专家账号已登录且资料管理页可用", steps: "资料管理-专家签名区手写后点击保存", expected: "提交成功进入待审核", priority: "P0", type: "positive", coverage: "资料手写签名提交" },
  ...
  { scene: "专业类别说明文案展示", precondition: "专家申请页", steps: "查看专业类别下方说明", expected: "展示与证书专业保持一致提示", priority: "P2", type: "positive", coverage: "提示展示" },
...
batch("招标发布", "PUB", [
  ...
  { scene: "报名信息对投标人隐藏互不可见", precondition: "项目已发布且多家已报名", steps: "投标人A在小程序查看项目报名信息区", expected: "不展示其他投标人单位信息", priority: "P0", type: "positive", coverage: "报名隐私" },
  { scene: "项目经理小程序可见报名名单", precondition: "项目已发布且多家已报名", steps: "项目经理在小程序进入项目报名入口", expected: "可见报名单位列表与后台一致", priority: "P0", type: "positive", coverage: "报名名单经办可见" },
...
batch("投标人项目管理", "BID", [
  ...
  { scene: "签字解密成功", precondition: "项目已开标且待解密", steps: "点击签字解密输入与递交约定一致的密码", expected: "解密成功并可供专家下载", priority: "P0", type: "positive", coverage: "解密主流程" },
  { scene: "签字解密密码错误", precondition: "项目已开标且待解密", steps: "输入错误密码", expected: "解密失败并提示密码错误", priority: "P0", type: "negative", coverage: "解密异常" },
  { scene: "递交解密密码非123456兼容性", precondition: "已开标待解密且递交密码非123456", steps: "输入与递交一致的自定义密码解密", expected: "应成功;若失败按缺陷记录并核对密码口径", priority: "P1", type: "boundary", coverage: "解密密码兼容" },
